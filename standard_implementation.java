...
public class standard_implementation {
...
//                    System.out.println("x "+x+" y "+y);
    ...
    //                    System.out.println();
        ...
        String fileName = cellNum+"_"+cellSize;
...
//        return ret;
//    }
    //keep track of whether or not a certain point has been discovered
...
//        System.out.println("removing");
    ...
    static int spawnSquare(int spawnX, int spawnY, int id) throws IOException{
        ...
        for (int i = spawnX; i < cellSize + spawnX; i++){
            change(i, spawnY, 2);
            change(i, spawnY + cellSize - 1, 2);
        }
        for (int j = spawnY; j < cellSize + spawnY; j++){
            change(spawnX, j, 2);
            change(spawnX + cellSize - 1, j, 2);
        }
        return 0;
    }
